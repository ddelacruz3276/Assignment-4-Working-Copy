...
{
    public class DCCountriesController : Controller
    {
        private readonly OECContext _context;

        public DCCountriesController(OECContext context)
        {
            _context = context;
        }
        ...
        // GET: DCCountries/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: DCCountries/Create
